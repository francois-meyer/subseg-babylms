"""
Reading times evaluator for SubSegDeBERTa.
...
We adapt the BabyLM reading pipeline to use word-level surprisal for SubSegDeBERTa.
...
Usage: Invoked via run_eval_subsegdeberta.py reading ... with the same args as the BabyLM pipeline.
"""

from subsegdeberta.word_surprisal import word_prob, load_model_and_tokenizer
...
if __name__ == "__main__":
    ...
    # CHANGED: score P(word|context) with SubSegDeBERTa's conditional marginal.
    p2_function = partial(word_prob, num_mask_tokens=args.number_of_mask_tokens_to_append)
